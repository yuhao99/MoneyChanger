...
<!-- Breadcrumb -->
<ol class="breadcrumb">
    <li class="breadcrumb-item">{{ __('app.settings.log.admin') }}</li>
    <li class="breadcrumb-item active">{{ __('app.settings.log.log') }}</li>
</ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="s_date" id="s_date" autocomplete="off" placeholder="dd/mm/yyyy">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="e_date" id="e_date" autocomplete="off" placeholder="dd/mm/yyyy">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select class="form-control" id="f_action" name="action">
                                ...
                                <option value="16">{{ __('app.settings.log.filter.action.update_ip_address') }}</option>
                                <option value="17">{{ __('app.settings.log.filter.action.new_ip_address') }}</option>
                                <option value="18">{{ __('app.settings.log.filter.action.update_skin') }}</option>
                                <option value="19">{{ __('app.settings.log.filter.action.create_skin') }}</option>
                                <option value="20">{{ __('app.settings.log.filter.action.create_maintenance') }}</option>
                                <option value="21">{{ __('app.settings.log.filter.action.delete_maintenance') }}</option>
                                <option value="22">{{ __('app.settings.log.filter.action.update_product_status') }}</option>
                                <option value="23">{{ __('app.settings.log.filter.action.create_admin_role') }}</option>
                                <option value="24">{{ __('app.settings.log.filter.action.delete_admin_role') }}</option>
                                <option value="25">{{ __('app.settings.log.filter.action.edit_admin_role') }}</option>
                                <option value="26">{{ __('app.settings.log.filter.action.manual_settle_event') }}</option>
                                <option value="27">{{ __('app.settings.log.filter.action.update_product_status_merchant') }}</option>
                                <option value="28">{{ __('app.settings.log.filter.action.create_tournament_skin') }}</option>
                                <option value="29">{{ __('app.settings.log.filter.action.set_default_tournament_skin') }}</option>
                                <option value="30">{{ __('app.settings.log.filter.action.update_tournament_skin_list') }}</option>
                                <option value="31">{{ __('app.settings.log.filter.action.create_bet_types') }}</option>
                                <option value="32">{{ __('app.settings.log.filter.action.update_bet_types') }}</option>                        
                                <option value="33">{{ __('app.settings.log.filter.action.update_team_rank') }}</option> 
                                <option value="34">{{ __('app.settings.log.filter.action.remove_team_rank') }}</option>  
                                <option value="35">{{ __('app.settings.log.filter.action.update_odds_setting') }}</option>  
                                <option value="36">{{ __('app.settings.log.filter.action.update_margin_setting') }}</option>  
                            </select>
                        </div>
                        @endif
                    </div>
